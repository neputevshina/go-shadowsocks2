...
GoDoc at https://godoc.org/github.com/neputevshina/go-shadowsocks2/

![Build and test](https://github.com/neputevshina/go-shadowsocks2/workflows/Build%20and%20test/badge.svg)
...
Pre-built binaries for common platforms are available at https://github.com/neputevshina/go-shadowsocks2/releases

Install from source

```sh
go get -u -v github.com/neputevshina/go-shadowsocks2
```
